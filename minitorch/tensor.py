...
class Tensor:
    ...
    def requires_grad_(self, x: bool) -> None:
        """Set the requires_grad flag, creating a history if needed."""
        self.history = History()

    def requires_grad(self) -> bool:
        """Returns True if this tensor has a history"""
    ...
    def all(self, dim: Optional[int] = None) -> Tensor:
        """Returns 1 if all are true (applies tensor function)"""
        if dim is None:
    ...
    def is_close(self, b: Tensor) -> Tensor:
        """Returns 1 if tensors are close"""
    ...
    def log(self) -> Tensor:
        """Applies log function"""
        return Log.apply(self)

    def exp(self) -> Tensor:
        """Applies exp function"""
